        ...
        if record.image or len(fields) != 1:
            for field in up_fields:
                if field in fields:
                    ...
                    product.with_delay(priority=10, eta=60).update_product()
                    break
...
class ProductListener(Component):
    ...
    def on_record_write(self, record, fields=None):
        ...
        for field in up_fields:
            if field in fields:
                record.with_delay(priority=10, eta=30).update_product()
                break
        ...
        for pack in packs:
            ...
            if min_stock:
                pack.product_tmpl_id.product_variant_ids.with_delay(priority=10, eta=30).update_product()

        if 'tag_ids' in fields:
            record.with_delay(priority=10, eta=30).unlink_product_tag_rel()
            record.with_delay(priority=10, eta=60).export_product_tag_rel()
...
class ProductBrandListener(Component):
    ...
    def on_record_create(self, record, fields=None):
        record.with_delay(priority=10).export_product_brand()
...
class BrandCountryListener(Component):
    ...
    def on_record_create(self, record, fields=None):
        record.with_delay(priority=10).export_product_brand_rel()
    ...
    def on_record_unlink(self, record):
        record.with_delay(priority=10).unlink_product_brand_rel()
...
class ProductTagsListener(Component):
    ...
    def on_record_create(self, record, fields=None):
        record.with_delay(priority=10, eta=60).export_product_tag()
        if 'product_ids' in fields:
            for product in record.product_ids:
                product.with_delay(priority=10, eta=30).unlink_product_tag_rel()
                product.with_delay(priority=10, eta=150).export_product_tag_rel()

    def on_record_write(self, record, fields=None):
        record.with_delay(priority=10, eta=120).update_product_tag()
        if 'product_ids' in fields:
            for product in record.product_ids:
                product.with_delay(priority=10).unlink_product_tag_rel()
                product.with_delay(priority=10, eta=120).export_product_tag_rel()

    def on_record_unlink(self, record):
        record.with_delay(priority=10).unlink_product_tag()
