...
class ProductProductExporter(Component):
    ...
    def update(self, binding, mode):
        vals = {
            ...
            'pvi_1': binding.pvi1_price,
            'pvi_2': binding.pvi2_price,
            'pvi_3': binding.pvi3_price,
            'pvi_4': binding.pvi4_price,
            'uom_name': binding.uom_id.name,
            'last_sixty_days_sales': binding.last_sixty_days_sales,
            'brand_id': binding.product_brand_id.id,
            'pvd_1': binding.pvd1_price,
            'pvd_2': binding.pvd2_price,
            'pvd_3': binding.pvd3_price,
            'pvd_4': binding.pvd4_price,
            'pvm': binding.pvm_price,
