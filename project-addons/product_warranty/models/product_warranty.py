...
class ProductSupplierinfo(models.Model):
    ...
    def _get_default_instructions(self):
        ...
        instruction_ids = self.env['return.instruction'].search([('is_default', '=', False)])
        if instruction_ids:
    ...
    warranty_return_partner = fields.Selection(
            ...
            string='Return type', default="company",
            required=True,
    ...
    return_instructions = fields.Many2one('return.instruction',
                                          'Instructions', default=_get_default_instructions,
                                          help="Instructions for product return")
    active_supplier = fields.Boolean('Active supplier',
                                     help="Is this supplier still active, only for information")
    warranty_return_address = fields.Many2one("res.partner",
                                              compute="_get_warranty_return_address", string="Return address",
