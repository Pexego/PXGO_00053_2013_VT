...
class SaleReport(models.Model):
    ...
    def _select(self):
        select_str = (", pc.parent_id as "
                      ...
                      "p.last_supplier_id as last_supplier")
    ...
    def _group_by(self):
        group_by_str = """, rp.ref, pc.parent_id, cs.name,
                          t.manufacturer, rp.vat, s.partner_shipping_id, p.last_supplier_id"""
