...
URL_SCSS_GEN_TEMPLATE = URL_BASE + 'custom_colors.%d.%s.gen.less'
...
class ResCompany(models.Model):
    ...
    SCSS_TEMPLATE = """
        .main-nav {
          ...
          > .o_menu_brand {
            color: %(color_navbar_text)s !important;
            &:hover, &:focus, &:active, &:open, &:focus:active:open {
          ...
          .container-fluid .o_sub_menu > .o_sub_menu_content > .oe_secondary_menu ul.dropdown-menu > li.dropdown-header {
              background-color: lighten(%(color_navbar_bg)s, 10%%) !important;
            }
        }
        .main-nav ul.nav {
            > li {
        ...
        .oe_highlight:not(.disabled) {
          color: %(color_button_text)s !important;
          background-color: %(color_button_bg)s !important;
          border-color: %(color_button_bg)s !important;
        }
        .oe_highlight:hover:not(.disabled) {
          color: %(color_button_text)s !important;
          background-color: %(color_button_bg_hover)s !important;
          border-color: %(color_button_bg_hover)s !important;
        }
                ...
                > thead {
                    ...
                    > tr {
                        &:first-child {
                            th:hover {
                                color: %(color_navbar_text)s !important;
                                background-color: darken(%(color_navbar_bg)s, 10%%) !important;
                            }
                        }
                    }
                }
                ...
                > tbody {
                    > tr {
                        > td {
                            ...
                            &.today:before {
                                border-bottom-color: %(color_navbar_bg)s !important;
                            }
                        }
                    }
                }
        ...
        .o_required_modifier.o_input, .o_required_modifier .o_input {
          background-color: lighten(%(color_navbar_bg)s, 30%%) !important;
        }
